...
for base_dataset in base_datasets:
    ...
    print(f"==============================================")
    if base_dataset in ["ETTh1","ETTh2","ETTm1","ETTm2"]:
        model_name = "DistDF-Fredformer"
    else:
        model_name = "DistDF-TimeBridge"
